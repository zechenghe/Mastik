...
for HPC_SEL in TOT_CYC #BR_CN BR_INS BR_MSP BR_NTK BR_PRC FP_INS L1_DCM L1_ICM L1_LDM L1_STM L1_TCM L2_TCA L2_TCM L3_TCA L3_TCM LD_INS SR_INS STL_ICY TLB_DM TLB_IM TOT_CYC TOT_INS
do
